...
public class InsertWrapper implements ISqlGenerate{
	...
	public InsertWrapper set(String name,Object value) {
	...
	public InsertWrapper(TableInfo tableInfo, Map<String, Object> insertData) {
		super();
		this.tableInfo = tableInfo;
		this.insertData = insertData;
	}

	public InsertWrapper(TableInfo tableInfo) {
		super();
		this.tableInfo = tableInfo;
	}
